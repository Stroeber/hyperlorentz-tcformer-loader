...
if __name__ == '__main__':
    ...
    ap.add_argument('--iterations', type=int, default=100, help='number of training iterations') #300
    ...
    ap.add_argument('--dataset', type=str, default='bcicha',
    ...
    ap.add_argument('--finetune', type=str2bool, default=True)
    ...
    ap.add_argument('--cutfill', type=str2bool, default=False)##Was True
