### Source Code taken from https://pytorchtime.com/docs/stable/_modules/torchtime/models/inception.html#InceptionTime
...
class InceptionTime(nn.Module):
    ...
    def forward(self, x: torch.Tensor, sub_id=None):
        x = x.squeeze(1)
        block_in = x
